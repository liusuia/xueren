...
// 消息类型
export const MSG_TYPE = { TEXT: 1, IMAGE: 2, FILE: 3, EMOJI: 4, SYSTEM: 5, CONTACT_CARD: 6, STICKER: 7, VOICE: 8 }
// 好友状态
export const FRIEND_STATUS = { PENDING: 0, ACCEPTED: 1, REJECTED: 2, BLOCKED: 3 }
// 群成员角色
export const GROUP_ROLE = { OWNER: 1, ADMIN: 2, MEMBER: 3 }

export const MSG_TYPE_LABEL = { 1: '文本', 2: '图片', 3: '文件', 4: '表情', 5: '系统', 6: '名片', 7: '表情' }
